...
ParityCKKS::ParityCKKS(std::string ccLocation, std::string pubKeyLocation, std::string multKeyLocation,
    ...
    m_InputLocation(inputLocation), m_OutputLocation(outputLocation) {

    initCC();
};

void ParityCKKS::initCC() {
...
void ParityCKKS::eval() {
}

void ParityCKKS::serializeOutput() {
